...
$APPLICATION->SetTitle("Битрикс блог");
?>
    <!-- banner -->
    ...
    <div class="nam-matis">
        <?php while ($ob = $res->GetNextElement()): $arFields = $ob->GetFields(); ?>
            ...
            <div class="col-md-6 nam-matis-1">
                <a href="<?= $arFields['DETAIL_PAGE_URL'] . '/' . $arFields['ID'] ?>"><img src="<?= $img ?>"
                                                                                           class="img-responsive"
                                                                                           alt="<?= $arFields['NAME'] ?>"></a>
                <h3>
                    <a href="<?= $arFields['DETAIL_PAGE_URL'] . '/' . $arFields['ID'] ?>"><?= mbCutString($arFields['NAME'], 10) ?></a>
                </h3>
